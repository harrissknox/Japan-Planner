...
function renderEventForm(couple) {
  ...
  form.addEventListener('submit', e => {
    ...
    saveData();
    // Optimistically render the UI so the user sees the new event
    // immediately.  If the save fails, we will revert the change
    // and re-render in the catch handler below.
    render();
    safeSave().catch(err => {
